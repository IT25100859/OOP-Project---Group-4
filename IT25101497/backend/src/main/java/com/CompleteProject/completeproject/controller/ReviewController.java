...
/**
 * ReviewController – manages the review and feedback flow (Component 06).
 *
 * URL map:
...
public class ReviewController {
    ...
    public String movieReviews(@RequestParam String title,
        ...
        // Pre-compute star string for average (e.g. 4.2 → "★★★★☆")
    ...
    /**
     * Builds a 5-star string from a double average, e.g. 4.2 → "★★★★☆".
