package com.CompleteProject.completeproject.util;

public class FilePathConstants {
    public static final String USERS_FILE      = "data/users.txt";
    public static final String MOVIES_FILE     = "data/movies.txt";
    public static final String SHOWTIMES_FILE  = "data/showtimes.txt";
    public static final String HALLS_FILE      = "data/halls.txt";
